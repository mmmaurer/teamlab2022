...
class BOW():
    ...
    def similarity(self, other):
        '''
        We define similarity as 1 - n^(-1) with n being the number of words in the intersection of two bags of words
    ...
    def distance(self, other):
        '''
        We define similarity as n^(-1) with n being the number of words in the intersection of two bags of words
